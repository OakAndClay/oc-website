  ...
  return (
    <div className="flex flex-col items-center mt-12">
        <ProductPage className="mb-20">
          <h2 className="font-cinzel text-4xl mb-4 font-bold">Custom Craft</h2>
          <h3 className="font-cinzel text-2xl mb-4 font-bold mt-10">Conceptual Development</h3>
          <p className="font-roboto text-lg mb-4">
            At Oak and Clay, we love diving into the exciting world of preliminary 
            conceptual development! We are here to turn your ideas into vibrant visual 
          ...
          <p className="font-roboto text-lg mb-4">
            When it comes to developing permit drawings and engineered drawings for your 
            timber frame project, our team has got you covered! From detailed floor 
            plans and elevation drawings to structural calculations and engineering 
            specifications, we handle it all with precision and expertise. We understand 
            that navigating the permit process can be overwhelming, but worry not! We 
            will guide you every step of the way, providing clear and concise documentation 
            that gets you one step closer to turning your timber frame vision into a reality. 
            With our dedication and thoroughness, you can rest assured that your project will 
            meet all the necessary requirements, leaving you free to focus on the excitement 
            of bringing your timber frame dream project to life.
          </p>
          <h3 className="font-cinzel text-2xl mb-4 font-bold mt-10">Piece Drawings</h3>
          <p className="font-roboto text-lg mb-4">
